...
class App:
    ...
    def verificar(self):
        ...
        if(usu == "root" and password == "1234") :
            ...
            self.logged_in = True  # Establecer logged_in en True
        else:
    ...
    def __init__(self):        
        ...
        logo =utl.leer_imagen("./imagenes/discovery.jpg", (505, 550))
        # frame_logo
        frame_logo = tk.Frame(self.ventana, bd=0, width=300, relief=tk.SOLID, padx=10, pady=10,bg='#3a7ff6')
        frame_logo.pack(side="left",expand=tk.YES,fill=tk.BOTH)
        label = tk.Label( frame_logo, image=logo,bg='#373738' )
        label.place(x=0,y=0,relwidth=1, relheight=1)
        
        #frame_form
        frame_form = tk.Frame(self.ventana, bd=0, relief=tk.SOLID, bg='#373738')
